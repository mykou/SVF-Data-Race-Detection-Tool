...
static cl::opt<bool>  ClInstrumentMemoryAccesses(
    "tsan-memory-accesses", cl::init(true),
    cl::desc("Instrument memory accesses"), cl::Hidden);
static cl::opt<bool>  ClInstrumentFuncEntryExit(
    "tsan-func-entry-exit", cl::init(true),
    cl::desc("Instrument function entry and exit"), cl::Hidden);
static cl::opt<bool>  ClInstrumentAtomics(
    "tsan-atomics", cl::init(true),
    cl::desc("Instrument atomics"), cl::Hidden);
static cl::opt<bool>  ClInstrumentMemIntrinsics(
    "tsan-memintrinsics", cl::init(true),
    cl::desc("Instrument memintrinsics (memset/memcpy/memmove)"), cl::Hidden);

static cl::opt<bool> RCAnno("rc", cl::init(false), cl::desc("Check Race Detection Annotation"));
...
char TSan::ID = 0;
static RegisterPass<TSan> TSAN("ptsan", "TSan: detects data races.");

/*
     * Get the Pass Name
     */
StringRef TSan::getPassName() const {
    return "TSan";
}
 ...
 */
void TSan::initializeCallbacks(Module &M) {
 ...
 * Initialize the pass.
 */
bool TSan::doInitialization(Module &M) {
 ...
 */
bool TSan::addrPointsToConstantData(Value *Addr) {
 ...
 */
void TSan::chooseInstructionsToInstrument(
...
/*
 * Check if the instruction I is an atomic operation
 */
 ...
 */
bool TSan::runOnFunction(Function &F) {
...
/*
 * Instruments load and store instructions
 */
bool TSan::instrumentLoadOrStore(Instruction *I,
                                 const DataLayout &DL) {
    IRBuilder<> IRB(I);
 ...
 */
bool TSan::instrumentMemIntrinsic(Instruction *I) {
    IRBuilder<> IRB(I);
...
/*
 * Instruments atomic instructions
 */
bool TSan::instrumentAtomic(Instruction *I, const DataLayout &DL) {
    IRBuilder<> IRB(I);
    if (LoadInst *LI = dyn_cast<LoadInst>(I)) {
 ...
 */
int TSan::getMemoryAccessFuncIndex(Value *Addr,
                                   const DataLayout &DL) {
