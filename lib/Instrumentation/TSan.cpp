...
static cl::opt<bool> RDAnnotation("rd-anno", cl::init(false), cl::desc("Check Race Detection Annotation"));
...
//static RegisterPass<TSan> TransformPass("ptsan", "TSan: detects data races.");

//INITIALIZE_PASS(TSan, "TSan",
//    "TSan: detects data races.",
//    false, false)

const char *TSan::getPassName() const {
    return "TSan";
}

//FunctionPass *llvm::createTSanPass() {
//  return new TSan();
//}
